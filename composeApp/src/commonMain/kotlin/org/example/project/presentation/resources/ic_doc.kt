...
val icDoc: ImageVector
    get() {
        if (_icDoc != null) return _icDoc!!
        
        _icDoc = ImageVector.Builder(
            name = "icDoc",
            defaultWidth = 40.dp,
            defaultHeight = 40.dp,
            viewportWidth = 40f,
            ...
            group {
                path(
                    fill = Brush.linearGradient(
                        colors = listOf(Color(0xFFF7F7F7), Color(0xFFE6E6E6)),
                        start = Offset(19f, 1f),
                        end = Offset(19f, 39f),
...
private var _icDoc: ImageVector? = null
